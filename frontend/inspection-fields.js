...
const PANEL_MAIN_ROWS = (p) => [
  ...
  { name: `${p}_wiretype`,      q: 'Wire Type:',                                     opts: CUAL },
  { name: `${p}_antiox`,        q: 'Anti-oxidant applied to aluminum terminals?',    opts: YNNA,
    showIf: { name: `${p}_wiretype`, equals: 'Aluminum' } },
...
const ROW_GROUPS = {
  ...
  sm: [
    ...
    { name: 'sm_age', q: 'Age of detectors (years):',                               inputType: 'text' },
  ...
  ac: [
    ...
    { name: 'ac_count',  q: 'How many open splices:',                inputType: 'text',
      showIf: { name: 'ac_q02', equals: 'Y' } },
    { name: 'ac_q03',    q: 'Any improper wiring methods observed?', opts: YNNA },
    { name: 'ac_rating', q: 'Overall:',                              opts: SRH  },
  ],

  hv: [
    { name: 'hv_min',    q: 'A/C Data Plate — Min Amps:', inputType: 'text' },
    { name: 'hv_max',    q: 'A/C Data Plate — Max Amps:', inputType: 'text' },
